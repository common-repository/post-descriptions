...
function postdescriptions_settings_init() {
	...
	add_settings_section(
		...
		__( 'General', 'post-descriptions' ),
		'postdescriptions_general_cb',
		'postdescriptions'
	);
...
function postdescriptions_important_color_cb( $args ) {
	...
	?>
	<input id="postdescriptions_important_color" class="color-picker" name="important-color" type="text" value="
	<?php
	if ( $color ) {
		echo $color;}
	?>
